...
Keep in mind that the semi-colon at the end is __required__ for this type of loop. The reason for this is to distinct itself from the previous while loop. More information 
